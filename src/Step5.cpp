...
Step5LinearConvection2D::Step5LinearConvection2D(const int windowWidth, const int windowHeight)
{
...
void Step5LinearConvection2D::applyInitialConditions()
{
...
void Step5LinearConvection2D::applyBoundaryConditions(std::vector<std::vector<double>>& newHeights)
{
...
void Step5LinearConvection2D::update(const double dt)
{
...
void Step5LinearConvection2D::draw(SDL_Renderer* renderer)
{
    if(heightMap == NULL)
    {
